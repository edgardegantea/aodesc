...
<div class="">
    <div class="row">
        @forelse($vehicles as $vehicle)
            ...
            <div class=" col-sm-6 col-xl-6 col-xs-12 mt-2 mb-2">
                <div class="card-header">
                    <h2 class="titlepage-h1">{{ $vehicle->brand }} {{ $vehicle->model }}</h2>
                </div>
                <div class="card-body">
                    <p class="text-primary font-weight-bold">{{ $vehicle->description }}</p>
                </div>
